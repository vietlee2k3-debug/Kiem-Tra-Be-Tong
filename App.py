...
# ==========================================
# CẤU HÌNH KẾT NỐI (ĐÃ CẬP NHẬT THEO YÊU CẦU)
# ==========================================
# Anh hãy thay đoạn 'TOKEN_CUA_ANH' bằng mã số dài từ BotFather
TELEGRAM_TOKEN = "789123456:AAFlK..." 
TELEGRAM_CHAT_ID = "6786726849" 
PIXEL_TO_MM = 0.1 
